...
class Setting extends Model {
	...
	protected function createSetting($arr)
	{
		...
		//default data
		$setting->comments = "{wow|waduh|walah|really|seriously|ga nyangka|masak sih} {kool|kueren|topdah|oklah|finee nice} {emoji1|emoji2|emoji3|emoji4|emoji5};{supper|vantastis|ketje|gaol} {voto|photo|foto|post|capturean} {hahaha|hehehe|hohoho} {kak|mas|bro|gan|sis} {emoji1|emoji2|emoji3|emoji4|emoji5};{masak|beneran|serius|ga boong|seriusan} {nih|nah|nich|barang ini} {wkwk|wkwkwk|ahahaha} {emoji1|emoji2|emoji3|emoji4|emoji5};{oh|oo|OMG|oh wow|hah} {kak|mas|bro|gan|sis} {emoji1|emoji2|emoji3|emoji4|emoji5};{gila|heboh|ga masuk akal} {banget|barang|ini} {emoji1|emoji2|emoji3|emoji4|emoji5};{haha|wkwkwkkkk|lols} {niceee|cool|pro|smile} {emoji1|emoji2|emoji3|emoji4|emoji5}";
