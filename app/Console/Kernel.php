...
class Kernel extends ConsoleKernel
{
    ...
    protected function schedule(Schedule $schedule)
    {
      ...
      $schedule->call(function () { //twice a day, cron notif member
      ...
      $schedule->call(function () {//check-create-affiliate
...
wget https://celebgramme.com/celebgramme/cron-notif-member twice a day
wget https://celebgramme.com/celebgramme/auto-follow-unfollow hourly
wget https://celebgramme.com/celebgramme/check-create-affiliate every minute
*/
    }
}
