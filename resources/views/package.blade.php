...
<html>
    <head>
      ...
      <link href="{{ asset('/css/package.css') }}" rel="stylesheet">
			...
			<!-- NEW Facebook Pixel Code celebpost initiate checkout pilih paket-->
			<script>
				!function(f,b,e,v,n,t,s)
				{if(f.fbq)return;n=f.fbq=function(){n.callMethod?
				n.callMethod.apply(n,arguments):n.queue.push(arguments)};
    ...
    <body>
      ...
      <div class="container">
        <div class="row content-all">
          ...
          <div class="content-package container col-sm-12 col-md-8 col-xs-12">  

            <h3 class="price-list"> Price List Auto Manage </h3>
            <div class="price-auto-manage col-sm-12 col-md-12 col-xs-12">
              <div class="row">
                <!--
                ...
                -->
                <div class="col-md-1" style="padding-right:8px;padding-left:8px;">
                </div>
                <div class="col-sm-offset-1 col-md-offset-0 col-sm-10 col-md-3 col-xs-12" style="padding-right:8px;padding-left:8px;margin-top:50px;" align="center">
                  <a href="{{url('checkout')}}/16">
                    <img src="{{url('images/price/prices-07.png')}}" class="img-responsive">
                  </a>
                </div>
                <div class="col-sm-offset-1 col-md-offset-0 col-sm-10 col-md-4 col-xs-12" style="padding-right:8px;padding-left:8px;" align="center">
              ...
              <div class="row">
                <div class="col-md-1" style="padding-right:8px;padding-left:8px;margin-right: 35px;">
                </div>
                <div class="col-sm-offset-1 col-md-offset-0 col-sm-10 col-md-3 col-xs-12" style="padding-right:8px;padding-left:8px;margin-top:10px;" align="center">
  ...
  <!--
            ...
            -->
              ...
              <div class="row col-sm-12 col-md-12 col-xs-12" style="text-align:center;">
                <a href="{{url('checkout')}}"><div class="order-now" ></div></a>
              </div>

                  <div class="description">
                    <div class="row">
                      <div class="col-md-6 col-sm-12 col-md-offset-3 col-xs-12" align="center">
                        <!--
                    ...
                    <div class="row">
                      <div class="content-description col-md-8 col-sm-10 col-md-offset-2 col-sm-offset-1 col-xs-12">
