					...
					<div class="h-l-300 body bg-lightGrey padding-0">
						<div class="row">
							<div class="col-md-12 col-sm-12 col-xs-12">
								<b>Perpanjang waktu berlangganan anda </b>
							</div>
						</div>

						<div class="row">
							<div class="col-md-12 col-sm-12 col-xs-12">
                <div class="col-md-2 col-sm-2 col-xs-12 col-card">
                  <div class="col-md-12 col-sm-12 col-xs-6 btn-tab">
                    <a class="btn btn-link btn-block bg-cyan normal br-6 text-white text-center" data-toggle="tab" id="button-package-normal">Normal</a>  
                  </div>
                  <div class="col-md-12 col-sm-12 col-xs-6 btn-tab">
                    <a class="btn btn-link btn-block bgBlueGreen text-white br-6 text-center" data-toggle="tab"  id="button-package-extra">Extra</a>  
								...
								<div class="tab-content">
								  <div id="normal" class="tab-pane fade in active">
									  <div class="row">
										<div class="col-md-3 col-sm-3 col-xs-12 col-card">
												...
												<div class="tab-content">
													<div id="DMInbox" class="tab-pane fade in active">
														<div class="row">
															...
															<div class="col-md-3 col-sm-12 col-xs-12">
																<button class="btn btn-lg br-6 bg-cyan btn-normal" id="button-refresh-DMInbox" data-is-refresh="1">Refresh</button>
															</div>
														</div>
														<div class="row">
															<div class="col-md-2 col-sm-12 col-xs-12">
