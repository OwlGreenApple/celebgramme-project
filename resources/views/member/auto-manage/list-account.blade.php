...
<div class="col-md-5 border-styling">
  ...
  <div class="row"> 
    ...
    <button data-id="{{$data->id}}" class="btn <?php if ($data->status=='stopped') { echo 'btn-danger'; } else {echo 'btn-success';} ?> button-action btn-{{$data->id}}" value="<?php if ($data->status=='stopped') { echo 'Start'; } else {echo 'Stop';}?>">
